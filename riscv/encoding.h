...
#define MATCH_CREADHPMCOUNTER 0x305b
#define MASK_CREADHPMCOUNTER  0xff07f
...
DECLARE_INSN(ctag, MATCH_CTAG, MASK_CTAG)
DECLARE_INSN(creadhpmcounter, MATCH_CREADHPMCOUNTER, MASK_CREADHPMCOUNTER)
#endif
#ifdef DECLARE_CSR
